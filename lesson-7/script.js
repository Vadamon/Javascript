...
function startGame() {
    ...
    setTimeout(createBomb, BOMB_SPEED);
}
...
function move() {
    ...
    if (new_unit === undefined) {
        new_unit = borderField(coord_y, coord_x);
    }
...
/**
 * Проверка не врезались ли в бомбу
 */
...
/**
 * Если змейка вышла за границу
 */
function borderField(coord_y, coord_x) {
    var unit;
    if (direction == 'x-') {
